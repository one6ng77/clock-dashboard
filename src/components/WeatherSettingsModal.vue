...
import { Droplets, ExternalLink, Leaf, PersonStanding, RefreshCw, Save, Sun, X } from 'lucide-vue-next'
...
<template>
  ...
  >
    ...
    <div class="relative max-w-lg bg-neutral-900 border border-white/10 rounded-3xl p-6 pb-3 text-white">
      ...
      <div>
        <div class="space-y-8 overflow-y-auto max-h-[55vh] border border-white/10 rounded-2xl p-3">
          <!-- Location Mode -->
          <section>
